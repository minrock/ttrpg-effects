...
- **Spec fuente:** `./specs/18-entity-scene-panel/26-dm-scene-aside.md`
...
- `specs/18-entity-scene-panel/26-dm-scene-aside.md` — actualizar estado a "En progreso" / "Implementada" al completar.
