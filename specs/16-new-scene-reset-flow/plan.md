...
- **Spec fuente:** `./specs/16-new-scene-reset-flow/16-new-scene-reset-flow.md`
...
- `specs/16-new-scene-reset-flow/16-new-scene-reset-flow.md`
- `specs/16-new-scene-reset-flow/plan.md`
