...
- **Spec fuente:** `./specs/21-scene-management/16-new-scene-reset-flow.md`
...
- `specs/21-scene-management/16-new-scene-reset-flow.md`
- `specs/21-scene-management/16-new-scene-reset-flow.plan.md`
