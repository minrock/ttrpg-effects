# Spec consolidado - Map And Grid

<!-- Archivo consolidado mecanicamente desde:
- 04-map-loading-grid-calibration.md
- 05-adjust-map.md
- 21-dnd5e-diagonals.md
-->

---

## Fuente: 04-map-loading-grid-calibration.md
