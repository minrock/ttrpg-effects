...
- **Spec fuente:** `./specs/22-virtual-minis-future/22-virtual-minis-future.md`
...
- **Render / PixiJS:** Crear una capa `tokens` con sprites de imagen, circunferencia de seleccion, badge numerico y hit area. La capa queda por encima de mapa/grilla/fog/darkness para que los tokens sean manipulables durante sesion, y por debajo de seleccion/UI React.
...
- `./specs/22-virtual-minis-future/22-virtual-minis-future.md` si durante implementacion se ajusta el alcance.
